/*
* Malcolm Roddy
* Systems Programming CSULB
* 09/14/2022
* This Program takes a deck of cards with stack data structure and dynamic array
* the winning hand is when the sum of the value of the cards has a number in the
* fibonacci sequence
*/
#include<math.h>
#include <iostream>
